...
/**
 * packageinfo rename for java files and corresponding configurations
 */
public class PackageRename {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 4) {
            System.out.println(
                    "Usage: PackageRename <src-path> <dst-path> <original-packageinfo-prefix> <alternative-packageinfo-prefix>");
