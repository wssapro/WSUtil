...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        DataSourceConfig dataSourceConfig = new DataSourceConfig()
                ...
                .setUsername("root")
                .setPassword("root")
                .setUrl("jdbc:mysql://192.168.1.71:3306/td_control?useUnicode=true&useSSL=false&characterEncoding=utf8")
                // 自定义数据库表字段类型转换【可选】
        ...
        PackageConfig packageConfig = new PackageConfig()
                .setParent("com.td")// 自定义包路径
                .setModuleName("control")//自定义模块名
                .setXml("mapper")//自定义模块名
